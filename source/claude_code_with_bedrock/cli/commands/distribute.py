    ...
    def _upload_landing_page_packages(self, profile, console: Console, package_path: Path) -> int:
        ...
        platform_files = {
            "windows": [
                ...
                ("otel-helper-go-windows.exe", "otel-helper-go-windows.exe"),
            ...
            "linux": [
                ...
                ("otel-helper-go-linux-x64", "otel-helper-go-linux-x64"),
                ("otel-helper-go-linux-arm64", "otel-helper-go-linux-arm64"),
            ...
            "mac": [
                ...
                ("otel-helper-go-macos-arm64", "otel-helper-go-macos-arm64"),
                ("otel-helper-go-macos-intel", "otel-helper-go-macos-intel"),
                ("install.sh", "install.sh"),
                ("config.json", "config.json"),
                ("README.md", "README.md"),
            ],
