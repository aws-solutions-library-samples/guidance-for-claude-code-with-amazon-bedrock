...
CLAUDE_MODELS = {
    "opus-4-7": {
        ...
        "profiles": {
            ...
            "au": {
                ...
                "description": "AU CRIS - Australia and New Zealand regions",
                "source_regions": [
                    "ap-southeast-2",
                    "ap-southeast-4",
                    "ap-southeast-6",
    ...
    "opus-4-7-1m": {
        ...
        "base_model_id": "anthropic.claude-opus-4-7[1m]",
        "profiles": {
            "us": {
                "model_id": "us.anthropic.claude-opus-4-7[1m]",
                "description": "US CRIS - US and Canada regions (1M context)",
                "source_regions": [
                    "us-east-1",
                    "us-east-2",
                    "us-west-1",
            ...
            "eu": {
                "model_id": "eu.anthropic.claude-opus-4-7[1m]",
                "description": "EU CRIS - European regions (1M context)",
                "source_regions": [
                    "eu-central-1",
                    "eu-central-2",
                    "eu-north-1",
            ...
            "au": {
                "model_id": "au.anthropic.claude-opus-4-7[1m]",
                "description": "AU CRIS - Australia and New Zealand regions (1M context)",
                "source_regions": [
                    "ap-southeast-2",
                    "ap-southeast-4",
                    "ap-southeast-6",
            ...
            "japan": {
                "model_id": "jp.anthropic.claude-opus-4-7[1m]",
                "description": "JP CRIS - Japan regions (1M context)",
                "source_regions": [
                    "ap-northeast-1",
                    "ap-northeast-3",
                ],
            ...
            "global": {
                "model_id": "global.anthropic.claude-opus-4-7[1m]",
                "description": "Global CRIS - All commercial AWS regions worldwide (1M context)",
                "source_regions": [
                    "us-east-1",
                    "us-east-2",
                    "us-west-1",
